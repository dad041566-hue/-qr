      ...
      <main className="flex-1 flex flex-col items-center px-4 sm:px-6 pt-20 md:pt-32 pb-10 md:pb-20 relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="w-full max-w-7xl mx-auto mb-16 md:mb-32 relative px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {/* Dashboard Image */}
            <div className="aspect-[4/3] sm:aspect-[4/5] lg:aspect-[4/5] bg-zinc-100 rounded-[2rem] overflow-hidden relative shadow-lg group cursor-pointer" onClick={() => navigate('/admin')}>
            ...
            {/* QR Order Image */}
            <div className="aspect-[4/3] sm:aspect-[4/5] lg:aspect-[4/5] bg-zinc-100 rounded-[2rem] overflow-hidden relative shadow-lg group cursor-pointer" onClick={() => navigate('/table/5')}>
            ...
            <div className="aspect-[4/3] sm:aspect-[4/5] lg:aspect-[4/5] sm:col-span-2 md:col-span-1 bg-zinc-100 rounded-[2rem] overflow-hidden relative shadow-lg group cursor-pointer" onClick={() => navigate('/admin')}>
